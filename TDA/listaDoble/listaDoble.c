...
int mostrarDerAIzq(const tLista *p, void(*mostrar)(const void *))
{
    tNodo *act = *p;
    int cant = 0;
...
int insertarEnOrden(tLista*p, const void *d, unsigned cantBytes, int(*comparar)(const void *, const void *),
